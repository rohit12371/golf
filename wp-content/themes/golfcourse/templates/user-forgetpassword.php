...
color: #fff; min-height:270px; text-align: center; width:100%; background-size: cover;">
  <h1 style="margin-top: 147px; color: #fff!important; font-size: 47px; font-family: 'Fjalla One', sans-serif!important;">Forget Password...</h1>
</div>
<div class="container">
          ...
          <div class="row">
            <div class="col-sm-12">
              <form role="form" method="post" enctype="multipart/form-data" id="forgetpasswordForm">
                ...
                <button type="submit" class="btn btn-default btn-lg btn-block">Forget Password</button>
              </form>
            </div>
          </div>
        </div>
