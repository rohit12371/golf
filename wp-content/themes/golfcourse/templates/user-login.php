...
color: #fff; min-height:270px; text-align: center; width:100%; background-size: cover;">
  <h1 style="margin-top: 147px; color: #fff!important; font-size: 47px; font-family: 'Fjalla One', sans-serif!important;">Login to your Account...</h1>
</div>
<div class="container">
          ...
          <div class="row">
            <div class="col-sm-12">
              <form role="form" method="post" enctype="multipart/form-data" id="loginForm">
                ...
                <button type="button" class="btn btn-default btn-lg btn-block" onclick="window.location.href='<?php echo site_url('forget-password'); ?>'">Forget Password</button>
